...
var canSeePersonsCount = function (heights) {
    ...
    const countSeenPersons = new Array(heights.length);
    const monotonicStack = new Array();
...
class Person {
     ...
     * @param {number} height
     * @param {number} index 
     * @param {number} peopleDirectlyHiddenByThisPerson
     */
    constructor(height, index, peopleDirectlyHiddenByThisPerson) {
        this.height = height;
        this.index = index;
        this.peopleDirectlyHiddenByThisPerson = peopleDirectlyHiddenByThisPerson;
    }
}
